...
import { useLazyGetUserReposeQuery, useSearchUsersQuery } from '../store/github/github.api';
...
const HomePage = () => {
    ...
    const [fetchRepos, { isLoading: areReposLoading, data: repos }] = useLazyGetUserReposeQuery()
    ...
    return (
        <div className="flex justify-center pt-10 mx-auto h-screen w-screen">
            ...
            <div className="relative w-[560px]">
                ...
                { repos?.map (repo => <RepoCard repos={repo} key={ repo.id }/>)}
            </div>
            </div>
        </div>
    );
